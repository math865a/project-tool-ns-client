import {
  Backdrop, CircularProgress, Typography, Box,Stack
} from '@mui/material';
...
function SectionLoading({height = 200, text = "Indlæser", fontSize = 13, bold = false}: ISectionLoadingProps){

    return(
        <Box flexGrow={1} height={height} minHeight={height} display="flex" alignItems="center" justifyContent="center" flexDirection="column">
            <CircularProgress/>
            {text && <Typography pt={2} fontSize={fontSize} fontWeight={bold ? "bold" : undefined}>
                {text}
            </Typography>}
        </Box>
    )
