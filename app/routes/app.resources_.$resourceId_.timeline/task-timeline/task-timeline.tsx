import { faChartGantt } from '@fortawesome/pro-light-svg-icons';
...
const TaskTimelineGrid = observer(() => {
    ...
    return (
        <Page.Section
            ...
            xs={12}
            minHeight="85vh"
            startActions={Controller.Store.Workpackages.length === 0 ? undefined : <TimelineControls/>}
        >
            {Controller.Store.Workpackages.length === 0 ? <Grid.NoRowsOverlay/> : 
            <Box
                width="100%"
                height="80vh"
                ...
                sx={{cursor: Controller.Calendar.isDragging ? "grabbing" : "grab"}}
            >
                <DataGridPro
                    columns={columns}
                    ...
                    getRowHeight={(row) => {
                        ...
                        return Model ? Model.h : BAR_HEIGHT + 2 * ROW_PADDING;
                    }}
