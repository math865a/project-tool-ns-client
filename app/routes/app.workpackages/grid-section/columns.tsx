...
export const columns: GridColDef<ViewRow>[] = [
    {
        ...
        width: 50,
        align: "center",
        renderCell: (props) => <Grid.LinkCell to={`${props.row.id}`} id={props.row.id}/>
    },
    {
        field: "contract",
        headerName: "Kontrakt",
    ...
    },
    {
        ...
        headerName: "Finanskilde",
        headerAlign: "center",
        align: "center",
        width: 85,
        valueGetter: (props) => props.row.financialSource.name,
        renderCell: Grid.renderCellExpand
    },
  {
        field: "serialNo",
        ...
        width: 75,
        align: "center",
        valueGetter: (props) => props.row.serialNo,
        renderCell: Grid.renderCellExpand
    },
    {
    ...
    /*{
        field: "propositionManager",
        headerName: "Tilbudsskribent",
        headerAlign: "center",
        width: 125,
        align: "center",
        valueGetter: (props) => props.row.propositionManager.name,
        renderCell: (props) => (
            <ProjectManagerCell projectManager={props.row.propositionManager} />
        ),
    },*/
    ...
    },
    {
        ...
        align: "center",
        headerAlign: "center",
        valueGetter: (props) => dt.fromISO(props.row.startDate).setZone("utc").toMillis(),
        valueFormatter: (props) => dt.fromMillis(props.value).setLocale("da").toFormat("d/M/yy"),
        renderCell: Grid.renderCellExpand
    },
    {
        field: "endDate",
        ...
        align: "center",
        headerAlign: "center",
        valueGetter: (props) => dt.fromISO(props.row.endDate).setZone("utc").toMillis(),
        valueFormatter: (props) => dt.fromMillis(props.value).setLocale("da").toFormat("d/M/yy"),
        renderCell: Grid.renderCellExpand
    },
    {
        ...
        align: "center",
        headerAlign: "center",
        valueGetter: (props) => getWorkDays(int.fromDateTimes(dt.fromISO(props.row.startDate), dt.fromISO(props.row.endDate))),
