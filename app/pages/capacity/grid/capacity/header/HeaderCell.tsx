...
import { Duration as dur, DateTime as dt } from 'luxon';
...
const CapacityHeaderCell = observer((props: { interval: ICapacityInterval; }) => {
    const Board = useBoard();

    const text = computed(() => {
        if (Board.View.viewMode === ViewMode.Day) {
            const date = props.interval.interval.start.setLocale('da');
            let primary: string = '';
