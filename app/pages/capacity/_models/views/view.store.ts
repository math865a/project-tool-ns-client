...
export class CapacityViewsStore extends Model({
    ...
    createView = () => {
        ...
        const dto: CreateCapacityViewDto = {
            viewId: generateId(),
            name:
                newNameCount > 0
        ...
        const View = this.resolve({ id: dto.viewId, ...dto, isDefault: false });
        this.Transport.createView(dto);
    ...
    updateDefaultView = (id: string, isDefault: boolean) => {
        ...
        this.Transport.updateDefaultView(dto);
    };
